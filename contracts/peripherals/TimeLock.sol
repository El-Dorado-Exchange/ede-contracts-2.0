...
contract Timelock is ITimelock, Ownable {
    ...
    //for pricefeed
    function setSpreadBasis(address _contract, address _token, uint256 _spreadBasis, uint256 _maxSpreadBasisUSD, uint256 _minSpreadBasisUSD) external onlyOwner {
