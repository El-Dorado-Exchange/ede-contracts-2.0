...
interface IEDEFundQUtils {
    ...
    // function getIncreaseOpeParas(address fund, uint256 _opeId) external view returns (address[]memory, uint256, uint256, uint256);
    // function getDecreaseOpeParas(address fund, uint256 _opeId) external view returns (address[]memory, uint256, uint256, uint256);
    ...
    //         uint256 _opeDef, uint256 _leverage, string memory _instruction) external returns (uint256);
    ...
    // function opeType(uint256 _opeId) external view returns (uint256, string memory);
